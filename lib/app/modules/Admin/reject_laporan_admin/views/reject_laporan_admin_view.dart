import 'package:aduan/app/modules/Admin/reject_laporan_admin/controllers/reject_laporan_admin_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class RejectLaporanAdminView extends GetView<RejectLaporanAdminController> {
  const RejectLaporanAdminView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(RejectLaporanAdminController());
    return Scaffold(
      appBar: AppBar(
