import 'package:aduan/app/modules/Admin/accept_laporan_admin/controllers/accept_laporan_admin_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class AcceptLaporanAdminView extends GetView<AcceptLaporanAdminController> {
  const AcceptLaporanAdminView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(AcceptLaporanAdminController());
    return Scaffold(
      appBar: AppBar(
